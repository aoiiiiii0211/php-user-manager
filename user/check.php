<?php
    ...
    $mail_address = isset($_POST['mail_adress']) ? $_POST['mail_adress'] : "";
        ...
        <?php if( empty($errors) ){?>
            ...
            <form method="POST" action="./check.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" readonly id="exampleInputEmail1" name="mail_adress" aria-describedby="emailHelp" value="<?php echo @$mail_address; ?>">
